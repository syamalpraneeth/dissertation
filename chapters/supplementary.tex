...
\begin{itemize}[noitemsep]
	\item Simulations + post-processing: \todo{Move code repository to public Github and add link here}
	\item Comparative data-processing pipelines:
\end{itemize}

\begin{figure}[!h] \centering
	\includegraphics[width=\textwidth]{codeflow.png}
	\mycaption{Simulation Repository Flowchart}{The various LAMMPS based semi-automated \gls{md} simulation workflows, and python data processing scripts developed for this thesis are depicted.}
\end{figure}
...
%	\begin{subfigure}{\textwidth} \centering
		\begin{subfigure}{0.42\textwidth} \centering %\renewcommand\thesubfigure{\alph{subfigure}1}
			\includegraphics[width=\textwidth,trim={0 0.8cm 0 0.2cm},clip]{50-50/post/enthalpy_2} \caption{}
		\end{subfigure}%
    	\hspace{0.2cm}
		\begin{subfigure}{0.42\textwidth} \centering %\renewcommand\thesubfigure{\alph{subfigure}2} 	\addtocounter{subfigure}{-1}
			\includegraphics[width=\textwidth,trim={0 0.8cm 0 0.2cm},clip]{50-50/post_8000/enthalpy_8000} \caption{}
		\end{subfigure}%
		\vfill
		\begin{subfigure}{0.42\textwidth} \centering  %\renewcommand\thesubfigure{\alph{subfigure}3} \addtocounter{subfigure}{-1}
			\includegraphics[width=\textwidth,trim={0 0.8cm 0 0.2cm},clip]{50-50/post_8000m/enthalpy_8000m} \caption{}
		\end{subfigure}
%		\addtocounter{subfigure}{-1}
%		\subcaption{Enthalpy vs Temperature: Varying RQ MG Preparation}
	\mycaption{Enthalpy vs Quench Rate for \cz RQ MGs}{Enthalpy ovolution is recording while changing quenching simulation processes. (a) Simulated as performed as discussed in Section~\ref{s:simtestMG}, (b) simulation starting with $\sim$8000 atoms at 2000 K, and (c) $\sim$8000 atoms melted from 50 K before quenching.}
	\label{f:enth_quench}
\end{figure}
...
\begin{figure}[!h]
	...
	\vfill
	\begin{subfigure}{\textwidth} 	\centering
		\includegraphics[width=0.5\textwidth,trim={0 0.5cm 0 0.3cm},clip]{3nm/50-50/heat-spike100/post/comp_3nm.png} \subcaption{}
	\end{subfigure}%
%	\vfill
%	\begin{subfigure}{\textwidth} 	\centering
%		\includegraphics[width=0.8\textwidth]{3nm/50-50/heat-spike100/post/comp-zr_3nm.png}
%	\end{subfigure}%
...
\begin{figure}[!h]
	\begin{subfigure}{0.5\textwidth}
		...
		\subcaption{3 nm cluster depositions}
	\end{subfigure}%
	\hfill
	\begin{subfigure}{0.5\textwidth}
...
\begin{figure}[!h]
	\centering
	\begin{subfigure}{0.49\linewidth} \centering \includegraphics[width=\textwidth]{1e10/voronoi_3nm_Cu50Zr50_CAMG_vs_MG_1e10_asp_Cu} 
		\subcaption{} \end{subfigure}%
	\hfill
	\begin{subfigure}{0.49\linewidth} \centering \includegraphics[width=\textwidth]{1e10/voronoi_3nm_Cu50Zr50_CAMG_vs_MG_1e10_asp_Zr}
		\subcaption{} \end{subfigure}
	\mycaption{Voronoi Polyhedra of 3 nm CAMGs for Cu- and Zr-centered atoms}{The Voronoi histograms are represented separately by species. (a) The Cu-centered atoms exhibit higher \gls{fi}-order (\vi{0}{0}{12}{0}) than (b) the Zr-centered atoms. The \gls{ilo} (not pictured) follows the same trend.}
	\label{f:voro_cu-zr}
\end{figure}
